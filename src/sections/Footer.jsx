...
const Footer = () => {
  return (
    <footer className='max-container py-16 bg-black text-white'>
            ...
            <div key={section.title}>
              ...
              <ul>
                {section.links.map((link) => (
                  <li
                    className='mt-3 font-montserrat text-base leading-normal hover:text-gray-400'
                    key={link.name}
                  >
      ...
      <div className='flex justify-between text-gray-400 mt-24 max-sm:flex-col max-sm:items-center'>
        ...
        <p className='font-montserrat cursor-pointer hover:text-gray-400'>
          Terms & Conditions
        </p>
      </div>
    </footer>
